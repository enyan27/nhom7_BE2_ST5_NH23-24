    ...
    <div class="product__items ">
        <div class="product__items--thumbnail">
            <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                <img class="product__items--img product__primary--img" src="./Suruchi - Shop Left Sidebar_files/product1.png" alt="product-img">
                <img class="product__items--img product__secondary--img" src="./Suruchi - Shop Left Sidebar_files/product2.png" alt="product-img">
            </a>
