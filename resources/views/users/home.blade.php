...
<main class="main__content_wrapper">
    ...
    <section class="hero__slider--section">
        <div class="hero__slider--inner hero__slider--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
            <div class="hero__slider--wrapper swiper-wrapper" id="swiper-wrapper-c1089fffd75b910f610" aria-live="off" style="transform: translate3d(-6908px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="2" role="group" aria-label="3 / 3" style="width: 1697px; margin-right: 30px;">
                                ...
                                <div class="col-lg-6 offset-lg-6">
                                    <div class="hero__slider--items__inner">
                                        <div class="slider__content text-center">
                                            ...
                                            <a class="primary__btn slider__btn" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/shop.html">Show Collection
                ...
                <div class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 1697px; margin-right: 30px;">
                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <p class="slider__content--desc desc2 d-sm-2-none mb-40">Up To 40% Off Final Sale Items. <br>
                                                Caught in the Moment!</p>
                                            <a class="slider__btn primary__btn" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/shop.html">Show Collection
                ...
                <div class="swiper-slide" data-swiper-slide-index="1" role="group" aria-label="2 / 3" style="width: 1697px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="2" role="group" aria-label="3 / 3" style="width: 1697px; margin-right: 30px;">
                    <div class="hero__slider--items home1__slider--bg three">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6 offset-lg-6">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 1697px; margin-right: 30px;">
                    <div class="hero__slider--items home1__slider--bg">
                        <div class="container-fluid">
                            <div class="hero__slider--items__inner">
                                <div class="row row-cols-1">
            ...
            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-c1089fffd75b910f610"></div>
            <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-c1089fffd75b910f610"></div>
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <div class="tab_content">
                @include('users.layouts.blocks.product-list')
                {{ $products->links() }}
                                ...
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                            <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product6.png" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product7.png" alt="product-img">
                                        </a>
                                    ...
                                    <div class="product__items--content">
                                        ...
                                        <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">High Ankle Jeans</a></h4>
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <div class="product__section--inner product__swiper--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-85e9437ae53b61ae" aria-live="polite" style="transform: translate3d(-1575px, 0px, 0px); transition-duration: 0ms;">
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product5.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product11.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product8.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product15.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product12.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product13.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product14.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product15.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product11.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product8.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product1.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product2.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product3.png" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product4.png" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">Sale</span>
                                </div>
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product5.png" alt="product-img">
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product8.png" alt="product-img">
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product12.png" alt="product-img">
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product14.png" alt="product-img">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product11.png" alt="product-img">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product1.png" alt="product-img">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 285px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Fashion eCommerce HTML Template_files/product3.png" alt="product-img">
                ...
                <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-85e9437ae53b61ae"></div>
                <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-85e9437ae53b61ae"></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
        </div>
    </section>
    ...
    <section class="blog__section section--padding pt-0">
        <div class="container-fluid">
            ...
            <div class="blog__section--inner blog__swiper--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-9993f5ee3ce225cd" aria-live="polite" style="transform: translate3d(-1575px, 0px, 0px); transition-duration: 0ms;">
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 5" style="width: 363.75px; margin-right: 30px;">
                        <div class="blog__items">
                            ...
                            <div class="blog__content">
                                ...
                                <h3 class="blog__content--title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/blog-details.html">Meet the Woman Behind Cool
                                        Ethical Label Refor </a></h3>
                                <a class="blog__content--btn primary__btn" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/blog-details.html">Read more </a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 5" style="width: 363.75px; margin-right: 30px;">
                        <div class="blog__items">
                            ...
                            <div class="blog__content">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/blog-details.html">Lauryn Hill Could Make Tulle
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 5" style="width: 363.75px; margin-right: 30px;">
                        <div class="blog__items">
                            ...
                            <div class="blog__content">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/blog-details.html">Fashion Trends In 2021 Styles,
                ...
                <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-9993f5ee3ce225cd"></div>
                <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-9993f5ee3ce225cd"></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
        </div>
    </section>
