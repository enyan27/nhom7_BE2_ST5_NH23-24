...
<main class="main__content_wrapper">
                ...
                <div class="col-lg-6">
                    <div class="about__thumb d-flex">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5 display-block" src="{{asset("customer/images/about-thumb-list1.png")}}" alt="about-thumb">
                        </div>
                        <div class="about__thumb--items position__relative">
                            <img class="about__thumb--img border-radius-5 display-block" src="{{asset("customer/images/about-thumb-list2.png")}}" alt="about-thumb">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <div class="about__author position__relative d-flex align-items-center">
                            ...
                            <img class="about__author--signature display-block" src="{{asset("customer/images/signature.png")}}" alt="signature">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumb">
                                <img class="team__thumb--img border-radius-50" src="./Suruchi - About Us_files/team1.png" alt="">
                            </div>
    ...
    <section class="testimonial__section bg__gray--color section--padding">
        <div class="container-fluid">
            ...
            <div class="testimonial__section--inner testimonial__swiper--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-ed8987fc41110ee8d" aria-live="polite" style="transform: translate3d(-1555px, 0px, 0px); transition-duration: 0ms;">
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb2.png" alt="testimonial-img">
                            </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb3.png" alt="testimonial-img">
                            </div>
                            <div class="testimonial__items--content">
                                <h3 class="testimonial__items--title">Nike Mardson</h3>
                                <span class="testimonial__items--subtitle">fashion</span>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb1.png" alt="testimonial-img">
                            </div>
                            <div class="testimonial__items--content">
                                <h3 class="testimonial__items--title">Nike Mardson</h3>
                                <span class="testimonial__items--subtitle">fashion</span>
                    ...
                    <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb1.png" alt="testimonial-img">
                            </div>
                    ...
                    <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb2.png" alt="testimonial-img">
                            </div>
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb3.png" alt="testimonial-img">
                            </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb1.png" alt="testimonial-img">
                            </div>
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 488.333px; margin-right: 30px;">
                        <div class="testimonial__items text-center">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img border-radius-50" src="./Suruchi - About Us_files/testimonial-thumb1.png" alt="testimonial-img">
                            </div>
                ...
                <div class="col">
                    <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset("/customer/images/brand-logo1.png")}}" alt="brand logo">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset("/customer/images/brand-logo2.png")}}" alt="brand logo">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset("/customer/images/brand-logo3.png")}}" alt="brand logo">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset("/customer/images/brand-logo4.png")}}" alt="brand logo">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset("/customer/images/brand-logo5.png")}}" alt="brand logo">
                        </div>
                    </div>
                </div>
            </div>
