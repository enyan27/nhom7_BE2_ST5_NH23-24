                            ...
                            <ul class="rating d-flex">
                                <li class="rating-list">
                                    <span class="rating-list-icon">
                                        <svg class="rating-list-icon-svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
            ...
            <div class="col">
                <ul class="product-details-tab nav d-flex mb-30">
                    <li class="product-details-tab-list">
                        <button class="product-details-tab-list-btn active" data-bs-toggle="tab" data-bs-target="#description" type="button">Description</button>
                    </li>
                    <li class="product-details-tab-list">
                        <button class="product-details-tab-list-btn" data-bs-toggle="tab" data-bs-target="#warrantypolicy" type="button">Warranty
                            Policy</button>
                    </li>
                    <li class="product-details-tab-list">
                        <button class="product-details-tab-list-btn" data-bs-toggle="tab" data-bs-target="#preserveguide" type="button">Preserve
                            Guide</button>
                    </li>
                    <li class="product-details-tab-list">
                        <button class="product-details-tab-list-btn" data-bs-toggle="tab" data-bs-target="#sizeguide" type="button">Size
                            Guide</button>
                    </li>
                </ul>
...
<div class="container">
    <form id="ratingFormAjax" action="{{route('reviews.store')}}" method="POST">
        @csrf
