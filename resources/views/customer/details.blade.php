    ...
    <section class="product__section product__section--style3 section--padding">
        <div class="container product3__section--container">
            ...
            <div class="product__section--inner product__swiper--column4__activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-54101859fcc5073c9" aria-live="polite" style="transform: translate3d(-1200px, 0px, 0px); transition-duration: 0ms;">
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 270px; margin-right: 30px;">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 270px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 270px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 270px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 270px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product3.png" alt="product-img">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 270px; margin-right: 30px;">
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                    <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product5.png" alt="product-img">
