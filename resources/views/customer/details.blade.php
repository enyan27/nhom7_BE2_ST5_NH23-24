                    ...
                    <div class="col">
                        <div class="product__details--media">
                            <div class="product__media--preview swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                <div class="swiper-wrapper" id="swiper-wrapper-7e4a5cd8d1035834c" aria-live="polite" style="transform: translate3d(-580px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="5" role="group" aria-label="6 / 6" style="width: 570px; margin-right: 10px;">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="./Suruchi - Product Details_files/big-product6.jpg"><img class="product__media--preview__items--img" src="{{asset("/$product->image_2")}}" alt="product-media-img"></a> 
                            ...
                            <div class="product__media--nav swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode swiper-thumbs">
                                <div class="swiper-wrapper" id="swiper-wrapper-87ec1e2960780524" aria-live="polite" style="transform: translate3d(-580px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product8.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product9.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product10.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product11.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="5" role="group" aria-label="6 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product12.png" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible swiper-slide-active swiper-slide-thumb-active" data-swiper-slide-index="0" role="group" aria-label="1 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product7.png" alt="product-nav-img">
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active swiper-slide-thumb-active" data-swiper-slide-index="0" role="group" aria-label="1 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product7.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 6" style="width: 106px; margin-right: 10px;">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="./Suruchi - Product Details_files/small-product8.png" alt="product-nav-img">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 6" style="width: 106px; margin-right: 10px;">
                        ...
                        <div class="product__details--info">
                            <form action="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html#">
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="./Suruchi - Product Details_files/product1.png" alt="variant-color-img"></label>
                                            <input id="color-red2" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="./Suruchi - Product Details_files/product2.png" alt="variant-color-img"></label>
                                            <input id="color-red3" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="./Suruchi - Product Details_files/product3.png" alt="variant-color-img"></label>
                                            <input id="color-red4" name="color" type="radio">
                                            <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="./Suruchi - Product Details_files/product4.png" alt="variant-color-img"></label>
                                        </fieldset>
                                    </div>
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="./Suruchi - Product Details_files/safe-checkout.png" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div id="reviews" class="tab_pane">
                                    <div class="product__reviews">
                                        <div class="product__reviews--header">
                                            ...
                                            <a class="actions__newreviews--btn primary__btn" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html#writereview">Write A Review</a>
                                        </div>
                                        <div class="reviews__comment--area">
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="./Suruchi - Product Details_files/comment-thumb1.png" alt="comment-thumb">
                                                </div>
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="./Suruchi - Product Details_files/comment-thumb2.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="./Suruchi - Product Details_files/comment-thumb3.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
        ...
        <section class="product__section product__section--style3 section--padding">
            <div class="container product3__section--container">
                ...
                <div class="product__section--inner product__swiper--column4__activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                    <div class="swiper-wrapper" id="swiper-wrapper-54101859fcc5073c9" aria-live="polite" style="transform: translate3d(-1200px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product8.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product15.png" alt="product-img">
                                    </a>
                                ...
                                <div class="product__items--content">
                                    ...
                                    <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Square Shoulder Bag</a></h4>
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product12.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product13.png" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Wool-blend Jacket</a></h4>
                                    <div class="product__items--price">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                                <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product14.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product15.png" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">Jacket, Women</span>
                                            <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Western denim shirt</a></h4>
                                            <div class="product__items--price">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product11.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product8.png" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Aware organic cotton</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product1.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product2.png" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h3 class="product__items--content__title h4"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Oversize Cotton Dress</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$110</span>
                                        <span class="price__divided"></span>
                        ...
                        <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product3.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product4.png" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h3 class="product__items--content__title h4"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Boxy Denim Jacket</a></h3>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product5.png" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="./Suruchi - Product Details_files/product11.png" alt="product-img">
                                    </a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle">Jacket, Women</span>
                                    <h4 class="product__items--content__title"><a href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">Quilted Shoulder Bag</a></h4>
                                    <div class="product__items--price">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product8.png" alt="product-img">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="4" role="group" aria-label="5 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product12.png" alt="product-img">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="5" role="group" aria-label="6 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                                <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product14.png" alt="product-img">
                        ...
                        <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="6" role="group" aria-label="7 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product11.png" alt="product-img">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product1.png" alt="product-img">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product3.png" alt="product-img">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product5.png" alt="product-img">
                        ...
                        </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 7" style="width: 270px; margin-right: 30px;">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="https://risingtheme.com/html/demo-suruchi-v1/suruchi/product-details.html">
                                        <img class="product__items--img product__primary--img" src="./Suruchi - Product Details_files/product8.png" alt="product-img">
                    ...
                    <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-54101859fcc5073c9"></div>
                    <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-54101859fcc5073c9"></div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
            </div>
        </section>
        <!-- End product section -->
                ...
                <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="./Suruchi - Product Details_files/shipping1.png" alt="">
                        </div>
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="./Suruchi - Product Details_files/shipping2.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="./Suruchi - Product Details_files/shipping3.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
                    ...
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                            <img src="./Suruchi - Product Details_files/shipping4.png" alt="">
                        </div>
                        <div class="shipping__items2--content">
